...
def display_ex(message):
    print('\033[1;31m',end='')
    print('#' * 80)
    print(f"\n\nCOMPLEX NUMBERS --- {message}\n\n")
    print('#' * 80)
    print('\033[0m',end='')
...
if __name__ == "__main__":
    ...
    u = Matrix([[Complex(0., 1.), Complex(0., 2.), Complex(0., 0.), Complex(0., 0.)],
                [Complex(0., 2.), Complex(0., 4.),
                 Complex(0., 0.), Complex(0., 0.)],
                [Complex(0., -1.), Complex(0., 2.), Complex(0., 1.), Complex(0., 1.)]])
    print(u.row_echelon_form())
    print(u.rank())
    # 2

    u = Matrix([[Complex(8., 5.), Complex(-2., 0.), Complex(0., 0.)],
                [Complex(4., 7.), Complex(20., 0.), Complex(0., 0.)],
                [Complex(7., 6.), Complex(1., 0.), Complex(0., 0.)],
                [Complex(21., 18.), Complex(7., 0.), Complex(0., 0.)]])
    print(u.row_echelon_form())
    print(u.rank())
    # 2